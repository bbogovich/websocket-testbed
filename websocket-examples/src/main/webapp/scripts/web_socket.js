...
(function() {
  ...
  console.log("Using flash-bridge websocket");
  ...
  /* 
   * If this script is dynamically loaded, it will be necessary to explicitly call 
   * WebSocket.__initialize from the parent script after the script completes loading.
   *  - BRB
  */
